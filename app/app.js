define(['angular',
    ...
    function (angular,home) {
        ...
        app.config(function ($routeProvider, $locationProvider) {
            $routeProvider.when('/scroll', {templateUrl: "app/scroll.html"});
            $routeProvider.when('/toggle', {templateUrl: "app/toggle.html"});
            $routeProvider.when('/tabs', {templateUrl: "app/tabs.html"});
            $routeProvider.when('/accordion', {templateUrl: "app/accordion.html"});
            $routeProvider.when('/overlay', {templateUrl: "app/overlay.html"});
            $routeProvider.when('/forms', {templateUrl: "app/forms.html"});
            $routeProvider.when('/carousel', {templateUrl: "app/carousel.html"});
        });
